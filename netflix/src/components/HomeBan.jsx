  ...
  return(
    <div className="home-banner">
      <div className="our-story">
        <h1 className="our-story-card-title" data-uia="hero-title">Binlerce film izleyin.</h1>
        <h2 className="our-story-card-subtitle" data-uia="our-story-card-subtitle">Her yerde sınırsız.</h2>
        <p className="email-form-title">Kayıt olun izlemeye başlayın</p>
